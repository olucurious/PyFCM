...
class FCMNotification(BaseAPI):
    def notify_single_device(
        ...
        Args:
            ...
            message_body (str):
            Message string to display in the notification tray
            data_message (dict):
            Data message payload to send alone or with the notification message
            sound (str):
            The sound file name to play. Specify "Default"
            for device default sound.
        ...
        Returns:
            :dict:
            `multicast_id(long), success(int), failure(int),
            canonical_ids(int), results(list)`:
            Response from FCM server.

        Raises:
            AuthenticationError:
            If :attr:`api_key` is not set or provided or
            there is an error authenticating the sender.
            FCMServerError:
            Internal server error or timeout error on
            Firebase cloud messaging server
            InvalidDataError: Invalid data provided
            InternalPackageError:
            Mostly from changes in the response of FCM,
    ...
    def single_device_data_message(
        ...
        Returns:
            :dict:`multicast_id(long), success(int),
            failure(int), canonical_ids(int), results(list)`:
            Response from FCM server.
        ...
        Raises:
            ...
            timeout error on Firebase cloud messaging server
            InvalidDataError: Invalid data provided
            InternalPackageError:
            Mostly from changes in the response of FCM,
            contact the project owner to resolve the issue
    ...
    def notify_multiple_devices(
        ...
        Args:
            ...
            message_body (str): Message string to display in the
            notification tray
            data_message (dict):
            Data message payload to send alone or with the notification message
            sound (str):
        ...
        Returns:
            :tuple:`multicast_id(long), success(int),
            failure(int), canonical_ids(int), results(list)`:
            Response from FCM server.
        ...
        Raises:
            ...
            If :attr:`api_key` is not set or provided or
            there is an error authenticating the sender.
            FCMServerError: Internal server error or
            timeout error on Firebase cloud messaging server
            InvalidDataError: Invalid data provided
            InternalPackageError: JSON parsing error,
            mostly from changes in the response of FCM,
    ...
    def multiple_devices_data_message(
        ...
        Raises:
            ...
            InvalidDataError: Invalid data provided
            InternalPackageError:
            JSON parsing error, mostly from changes in the response of FCM,
            create a new github issue to resolve it.
        """
        payloads = list()
        registration_id_chunks = self.registration_id_chunks(registration_ids)
    ...
    def notify_topic_subscribers(
        ...
        Args:
            ...
            A topic name is a string that can be formed with any character in
            [a-zA-Z0-9-_.~%]
            message_body (str): Message string to display in the
            notification tray
            data_message (dict): Data message payload to send alone or
            with the notification message
            sound (str): The sound file name to play.
            Specify "Default" for device default sound.
